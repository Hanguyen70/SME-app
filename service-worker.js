/* Seahorse Manager — Service Worker  [BUILD-TAG: v3.14.85 — FIX BUG GỐC form user: editUser không truyền funcGroups/isDeptHead/fullName → mỗi lần Lưu xóa trắng; gộp Lưu+Đẩy auth]
